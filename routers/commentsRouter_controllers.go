...
func init() {
    ...
    beego.GlobalControllerRouter["github.com/udistrital/sga_mid_notas/controllers:NotasController"] = append(beego.GlobalControllerRouter["github.com/udistrital/sga_mid_notas/controllers:NotasController"],
